...
plt.plot(x_train, y_train, label='Funzione Reale ($x^3 + x^2 - x - 1$)', color='blue', linewidth=3)
# La curva che la nostra rete ha imparato
plt.plot(x_train, y_pred, label='Approssimazione Rete Neurale', color='red', linestyle='--', linewidth=2)
