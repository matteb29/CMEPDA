...
from sklearn.model_selection import (
    train_test_split,
)  # per splittare il dataset in training e valutazione
...
print(
    np.stack((y_model, y_test), axis=1)
)  # qui creo una tabella di confronto tra le etichette di test
...
print(
    y_model != y_test
)  # questo stampa un array di False, True. False se il modello ha azzeccato e quindi
...
print(
    sum(y_model == y_test) / len(y_model)
)  # così stampo quantre volte il modello ha azzeccato
