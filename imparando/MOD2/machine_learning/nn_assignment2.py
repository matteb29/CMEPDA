...
import numpy as np
from keras.layers import Dense, Dropout, Flatten, Input  # nuovi import
...
risultati_training = rete.fit(
    dati_training,
    y_training,
    validation_data=(dati_validation, y_validation),
    epochs=200,
    verbose=0,
)
...
print(
    f"Shape del validation {y_validation.shape}, shape dei valori predetti {y_predetto.shape}"
)
...
risultati_rete_densa = rete_densa.fit(
    dati_training,
    y_training,
    validation_data=(dati_validation, y_validation),
    epochs=30,
