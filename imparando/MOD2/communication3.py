...
if __name__ == "__main__": 
    ...
    with multiprocessing.Manager() as manager:
        ...
        list_elements=[1,2,3,4] #c' è una variabile globale che si chiama list_elements



        records=manager.list(list_elements) #serve per creare una variabile di tipo lista 
